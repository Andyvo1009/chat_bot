...
import time
# Title and subtitle
st.set_page_config(page_title="Financer", layout="centered",
menu_items = {
...
def main():
    ...
    if user_input := st.chat_input("Type your message..."):
        system_prompt='''System:Your are an finance assistant. If the prompt is not related to finance.You should try to consider the topic of the question and answer to it rather than assuming that is not related to Finance . 
